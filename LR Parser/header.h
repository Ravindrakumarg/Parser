...
{
	char *ch;
	struct _i_start *down;
	struct _dot_start *nloc;
};
...
//
int generate_itemset(struct _start *);

//
int tt(struct _start *);

//
struct _i_start *  first_item_set(struct _start *);
